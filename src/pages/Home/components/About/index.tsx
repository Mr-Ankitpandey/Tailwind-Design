    ...
    <div className="flex flex-col gap-8 md:flex-row md:gap-6" id="about">
      <div className="lg:pr-12.25">
        <div className="flex flex-col gap-5 md:gap-5.75">
          <div>
            <Button className="px-6 py-3 bg-neutral-100 text-[18px] border rounded-sm">ABOUT US</Button>
          </div>
        ...
        <div className="lg:mt-6">
          ...
          <div className="flex md:gap-2.5 items-center mt-1 lg:mt-8 px-6 py-6 bg-neutral-50 rounded-sm">
